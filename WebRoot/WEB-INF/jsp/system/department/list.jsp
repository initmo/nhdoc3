...
function doOnLoad() {
    ...
    dhxToolbar.addButton   ("new",1,"新增部门", "new.gif");
...
function attachList() {
	...
	listGrid.setHeader("<a class=link href='javascript:listGrid.checkAll(true);'>选择</a>,编号,部门名称,上级部门,操作");
	listGrid.setInitWidths("40,80,250,*,100");
	listGrid.setColAlign("center,center,left,left,center");
	listGrid.setColTypes("ch,ro,ro,ro,link");
	listGrid.setColSorting(",int,str,str,str");
	listGrid.init();
...
/**修改**/
function edit(id){
 	window.location.href="edit?deptId="+id;
}
...
function del(id) {
if(confirm(" 确认删除该机构吗？     ")){
	window.location.href="delete?deptId="+id;
/*
	$.ajax({
